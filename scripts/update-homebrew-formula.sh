...
DEFAULT_FORMULA_PATH="$REPO_ROOT/homebrew/autosort-mac.rb"

OWNER="${OWNER:-life2you}"
REPO="${REPO:-autosort-mac}"
HOMEPAGE="${HOMEPAGE:-https://github.com/$OWNER/$REPO}"
FORMULA_CLASS="${FORMULA_CLASS:-AutosortMac}"
BINARY_NAME="${BINARY_NAME:-autosort-mac}"
ASSET_BASENAME="${ASSET_BASENAME:-autosort-mac}"
DESCRIPTION="${DESCRIPTION:-Automatically organize Desktop and Downloads files on macOS}"
VERSION=""
